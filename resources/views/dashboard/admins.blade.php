...
@component('dashboard.partials.content')
	...
	@if(count($admins))
		...
		@foreach($admins as $admin)
			<li><span>{{$admin->name}}</span><a href="{{url('admins/'.$admin->id.'/edit')}}" class="edit" title="edit"><i class="fa fa-wrench"></i></a><a href="#delete-leanmodal" data-id="{{$admin->id}}" class="delete" rel="leanModal" title="delete"><i class="fa fa-remove"></i></a></li><br/>
